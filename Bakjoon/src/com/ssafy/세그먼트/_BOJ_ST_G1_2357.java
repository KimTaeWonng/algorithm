...
public class _BOJ_ST_G1_2357 {
	...
	public static void main(String[] args) throws IOException {
		...
		SegmentTree minSeg = new SegmentTree(N);
		SegmentTree maxSeg = new SegmentTree(N);
		
		minSeg.minInit(arr, 1, 1, N);
		maxSeg.maxInit(arr, 1, 1, N);
		...
		for (int i = 0; i < M; i++) {
			...
			bw.write(minSeg.checkMin(1, 1, N, left, right) + " " + maxSeg.checkMax(1, 1, N, left, right) + "\n");
		}
